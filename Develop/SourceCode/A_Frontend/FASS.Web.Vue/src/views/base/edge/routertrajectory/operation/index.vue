...
<template>
  <div :class="['flex', 'justify-between', deviceDetection() && 'flex-wrap']">
    <div :class="[deviceDetection() ? ['w-full', 'mt-2'] : 'w-[calc(100%)]']">
      ...
      >
        <el-form-item :label="$t('table.coordinatesX')">
          <el-input
            v-model="query.coordinatesX"
            :placeholder="$t('table.coordinatesX')"
            clearable
            class="!w-[200px]"
        /></el-form-item>
        <el-form-item :label="$t('table.coordinatesY')">
          <el-input
            v-model="query.coordinatesY"
            :placeholder="$t('table.coordinatesY')"
            clearable
            class="!w-[200px]"
        /></el-form-item>
