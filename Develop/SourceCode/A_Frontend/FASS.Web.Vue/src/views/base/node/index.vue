...
const zoneId = ref(newFormInline?.value.id ?? "");
defineOptions({
  name: "Base-Zone"
});
/**
...
<template>
  <div :class="['flex', 'justify-between', deviceDetection() && 'flex-wrap']">
    <div :class="[deviceDetection() ? ['w-full', 'mt-2'] : 'w-[calc(100%)]']">
      ...
      >
        <!-- <el-form-item :label="$t('table.classification')" prop="kind">
          <el-input
            v-model="query.kind"
