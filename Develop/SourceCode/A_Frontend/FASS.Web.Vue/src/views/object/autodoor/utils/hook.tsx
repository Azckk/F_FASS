...
import { getPage, addOrUpdate, deletes } from "@/api/object/autodoor";
...
export function useHook(tableRef: Ref) {
  ...
  const columns: TableColumnList = [
    ...
    {
      headerRenderer: () => t("table.prevNodeId"),
      label: "table.prevNodeId",
      prop: "prevNodeId"
    },
    {
      headerRenderer: () => t("table.nextNodeId"),
      label: "table.nextNodeId",
      prop: "nextNodeId"
    },
    {
    ...
    {
      headerRenderer: () => t("table.isAdvance"),
      label: "table.isAdvance",
      prop: "isAdvance",
      cellRenderer: ({ row, props }) => (
        <el-icon color={row.isAdvance ? "green" : "red"} class="no-inherit">
          {row.isAdvance ? (
    ...
    // { label: "操作", slot: "operation", minWidth: 250 }
  ];
