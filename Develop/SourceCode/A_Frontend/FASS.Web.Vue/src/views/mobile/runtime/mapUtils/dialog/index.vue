...
async function sendGoWhere() {
  ...
  let data = JSON.stringify({
    id: sendData.value.targetNodeId, // 替换为code
    carCode: props.data.code.text
  });
      ...
      <div>
        <el-form :model="props.data" label-width="auto" label-position="left">
          ...
          <div v-if="msg == '站点'">
            ...
            <div class="operationBtn" @click="handleClickSite">
              <el-button
          ...
          <div v-if="msg == '车辆'">
            <span class="title">{{ $t("table.quickOperation") }}</span>
            <div class="operationBtn" @click="handleClickCar">
              <el-button
                data-action="goWhere"
                color="#5A3092"
                style="width: 80px; height: 40px"
