  ...
  <div :class="['flex', 'justify-between', deviceDetection() && 'flex-wrap']">
    <div :class="[deviceDetection() ? ['w-full', 'mt-2'] : 'w-[calc(100%)]']">
      ...
      >
        ...
        <el-form-item :label="$t('table.car')" prop="car">
          <el-select
            v-model="query.carId"
            filterable
            class="!w-[200px]"
        ...
        <el-form-item :label="$t('table.actionType')" prop="actionType">
          <el-select
        ...
        <el-form-item :label="$t('table.state')" prop="state">
          ...
          >
            <el-option label="--全部--" value="" />
            <el-option
              v-for="item in TaskInstanceActionStateList"
              :key="item.id"
              :label="item.name"
              :value="item.code"
            />
