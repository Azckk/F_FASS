...
import PhoneFilled from "@iconify-icons/ep/chat-dot-round";
import Pause from "@iconify-icons/ep/video-pause";
  ...
  <div :class="['flex', 'justify-between', deviceDetection() && 'flex-wrap']">
    <div :class="[deviceDetection() ? ['w-full', 'mt-2'] : 'w-[calc(100%)]']">
      ...
      >
        ...
        <!-- <el-form-item :label="$t('table.state')" prop="name">
          <el-input
            v-model="query.state"
        ...
        <el-form-item :label="$t('table.state')" prop="state">
          ...
          >
            ...
            <el-option
              v-for="item in CarInstantActionStateList"
              :key="item.id"
              :label="item.name"
              :value="item.code"
            />
      ...
      >
        <template #buttons>
          ...
          <el-button
            ...
            @click="handleBtnProcess()"
          >
            {{ $t("buttons.subtasks") }}
          </el-button>
          <el-button
            type="warning"
            :icon="useRenderIcon(PhoneFilled)"
            @click="handleRelease()"
          >
            {{ $t("buttons.publish") }}
          </el-button>
          ...
          <el-dropdown style="margin-left: 12px">
            ...
            <template #dropdown>
              <el-dropdown-menu>
                <el-dropdown-item @click="handleDeleteM3()">{{
                  $t("buttons.threeMonths")
                }}</el-dropdown-item>
                <el-dropdown-item @click="handleDeleteM1()">
                  {{ $t("buttons.oneMonths") }}</el-dropdown-item
                >
                <el-dropdown-item @click="handleDeleteW1()">{{
                  $t("buttons.oneWeek")
                }}</el-dropdown-item>
                <el-dropdown-item @click="handleDeleteD1()">{{
                  $t("buttons.oneDay")
                }}</el-dropdown-item>
                <el-dropdown-item @click="handleDeleteAll()">{{
                  $t("buttons.clearAll")
                }}</el-dropdown-item>
              </el-dropdown-menu>
            </template>
