...
import { getPage, addOrUpdate, deletes } from "@/api/warehouse/tag";
...
export function useHook(tableRef?: Ref | undefined) {
  ...
  const columns: TableColumnList = [
    ...
    {
      headerRenderer: () => t("table.tagName"),
      label: "table.tagName",
      prop: "name",
      sortable: true
    },
    {
      headerRenderer: () => t("table.tagColor"),
      label: "table.tagColor",
      prop: "colour",
      sortable: true,
    ...
    {
      headerRenderer: () => t("table.tagParameters"),
      label: "table.tagParameters",
      prop: "value",
      sortable: true,
      cellRenderer: ({ row, props }) => (
