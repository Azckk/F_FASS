...
<template>
  <el-row :gutter="20">
    <el-col :span="8" class="center">
      <div>容器状态</div>
      <div>图片</div>
      <el-button type="info" @click="handleContainer(1)">设置</el-button>
    </el-col>
    <el-col :span="8" class="center">
      <div>物料状态</div>
      <div>图片</div>
      <el-button type="info" @click="handleContainer(2)">设置</el-button>
    </el-col>
    <el-col :span="8" class="center">
      <div>任务起始点</div>
      <div>图片</div>
      <el-button type="info" @click="handleContainer(3)">设置</el-button>
    </el-col>
  </el-row>
