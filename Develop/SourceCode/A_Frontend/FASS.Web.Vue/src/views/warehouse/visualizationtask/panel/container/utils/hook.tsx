...
export function useHook(
  ...
  function handleMaterial(rows = selection.value) {
    ...
    addDialog({
      title: "物料",
      props: { roleId: keyValue.value, containersId: row.id },
      width: "80%",
      alignCenter: true,
      draggable: true,
      fullscreenIcon: true,
