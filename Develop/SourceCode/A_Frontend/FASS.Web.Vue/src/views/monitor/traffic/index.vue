  ...
  <div :class="['flex', 'justify-between', deviceDetection() && 'flex-wrap']">
    <div :class="[deviceDetection() ? ['w-full', 'mt-2'] : 'w-[calc(100%)]']">
      ...
      >
        ...
        <el-form-item :label="$t('table.fromCarCode')" prop="fromCarName">
          <el-input
            v-model="query.fromCarName"
            :placeholder="$t('table.name')"
            clearable
            class="!w-[200px]"
          />
        </el-form-item>
        <el-form-item :label="$t('table.toCarCode')" prop="toCarName">
          <el-input
            v-model="query.toCarName"
            :placeholder="$t('table.name')"
            clearable
            class="!w-[200px]"
          />
