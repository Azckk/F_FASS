...
export function useHook(tableRef: Ref) {
  ...
  const query = reactive({
    ...
    // createAt: dayjs().subtract(1, "week").toDate()
  });
  ...
  const columns: TableColumnList = [
    ...
    // {
    //   headerRenderer: () => t("table.fromCarCode"),
    //   label: "table.fromCarCode",
    //   prop: "fromCarCode"
    // },
    // {
    //   headerRenderer: () => t("table.toCarCode"),
    //   label: "table.toCarCode",
    //   prop: "toCarCode"
    // },
    {
      headerRenderer: () => t("table.fromCarCode"),
      label: "table.fromCarName",
      prop: "fromCarName"
    },
    {
      headerRenderer: () => t("table.toCarCode"),
      label: "table.toCarName",
      prop: "toCarName"
    },
    {
      headerRenderer: () => t("table.controlTime"),
      label: "table.controlTime",
      prop: "continue"
    },
    {
      headerRenderer: () => t("table.lockedNodes"),
      label: "table.lockedNodes",
      prop: "lockedNodes"
    },
    {
