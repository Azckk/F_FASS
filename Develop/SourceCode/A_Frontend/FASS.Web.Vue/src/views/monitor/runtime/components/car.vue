...
const updateDataList2 = throttle(newVal => {
    ...
    <div class="content-table">
      ...
      >
        ...
        <el-table-column
          align="center"
          prop="name"
          :label="$t('table.carName')"
          sortable
          width="120px"
          @click="handleRowNameClick"
        />
        <el-table-column
          align="center"
          prop="currNodeCode"
          :label="$t('table.currentSite')"
        />
        <el-table-column
          align="center"
          prop="state"
          :label="$t('table.carStatus')"
        />
        <el-table-column
          align="center"
          prop="charge"
