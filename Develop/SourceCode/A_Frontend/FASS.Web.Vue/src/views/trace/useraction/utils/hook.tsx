...
export function useHook(tableRef: Ref) {
  ...
  const columns: TableColumnList = [
    ...
    {
      headerRenderer: () => t("table.controller"),
    ...
    {
      headerRenderer: () => t("table.timing"),
      label: "table.timing",
      prop: "watch"
    },
    {
      headerRenderer: () => t("table.responseCode"),
      label: "table.responseCode",
      prop: "responseCode"
    },
    {
  ...
  function handleRow(row = undefined) {
    return {
      ...
      requestToken: row?.requestToken ?? null,
