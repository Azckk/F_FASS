...
import { getPage, addOrUpdate, deletes } from "@/api/data/envelope";
...
export function useHook(tableRef?: Ref | undefined) {
  ...
  const columns: TableColumnList = [
    ...
    {
      headerRenderer: () => t("table.envelopeProperties"),
      label: "table.envelopeProperties",
      prop: "name",
      sortable: true
    },
    {
      headerRenderer: () => t("table.envelopeDescription"),
      label: "table.envelopeDescription",
      prop: "description",
      sortable: true
    },
    {
      headerRenderer: () => t("table.envelopeParameter"),
      label: "table.envelopeParameter",
      prop: "value",
      sortable: true,
