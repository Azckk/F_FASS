...
import { getPage, addOrUpdate, deletes } from "@/api/data/planrules";
...
export function useHook(tableRef?: Ref | undefined) {
  ...
  const columns: TableColumnList = [
    ...
    {
      headerRenderer: () => t("table.pathPlanningConfiguration"),
      label: "table.pathPlanningConfiguration",
      prop: "name",
      sortable: true
    },

    {
      headerRenderer: () => t("table.configurationParameters"),
      label: "table.configurationParameters",
      prop: "value",
      sortable: true,
