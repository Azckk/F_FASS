...
{
    public class ReceiveCallMessage
    {
        /// <summary>
        /// 起始码
        /// </summary>
        ...
        /// 预留字段
        /// </summary>
        public byte[] Reserve { get; set; } = new byte[22];
        ...
        public ReceiveCallMessage SetMessage(
            byte command,
            ushort car,
            byte storageNo,
            byte callMode,
        ...
        public ReceiveCallMessage GetMessage(byte[] byteArray)
        {
