...
{
    public class TrafficRulesEntityType : AuditEntityType<TrafficRulesEntity>
    {
        public override void Configure(EntityTypeBuilder<TrafficRulesEntity> builder)
        {
            base.Configure(builder);
            builder.ToTable("data_traffic_rules");
            ...
            builder.Property(e => e.Value).HasColumnName("value").HasColumnType("varchar(100)").HasComment("配置参数值").IsRequired();
