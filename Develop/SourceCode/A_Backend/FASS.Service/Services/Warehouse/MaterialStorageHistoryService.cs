...
{
    public class MaterialStorageHistoryService : AuditService<FrameContext, MaterialStorageHistoryEntity, MaterialStorageHistoryDto>, IMaterialStorageHistoryService
    {
        public MaterialStorageHistoryService(
            IUnitOfWork<FrameContext> unitOfWork,
            IRepository<FrameContext, MaterialStorageHistoryEntity> repository,
            IMapper mapper,
            IValidator<MaterialStorageHistoryDto> validator)
