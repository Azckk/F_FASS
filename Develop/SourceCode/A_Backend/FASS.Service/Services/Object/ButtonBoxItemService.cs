...
{
    public class ButtonBoxItemService
        : AuditService<FrameContext, ButtonBoxItemEntity, ButtonBoxItemDto>,
            IButtonBoxItemService
    {
        public ButtonBoxItemService(
            IUnitOfWork<FrameContext> unitOfWork,
            IRepository<FrameContext, ButtonBoxItemEntity> repository,
            IMapper mapper,
            IValidator<ButtonBoxItemDto> validator
        )
